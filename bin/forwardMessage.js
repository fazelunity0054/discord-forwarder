...
function forwardMessage(channel, message, options, edit) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let { username } = author;
        let avatarURL = (_a = options.webhookAvatarURL) !== null && _a !== void 0 ? _a : author.displayAvatarURL();
        let content = "";
        let embeds = [];
        ...
        if (!((_b = options.copyAttachments) !== null && _b !== void 0 ? _b : true)) {
            attachments = new Discord.Collection();
        }
        if ((_c = options.copyEmbed) !== null && _c !== void 0 ? _c : true) {
            embeds.push(...message.embeds);
        }
        if (options.embed) {
            let embed = new Discord.MessageEmbed()
                .setColor((_d = options.embed.color) !== null && _d !== void 0 ? _d : "#2F3136")
                .setTitle((_e = options.embed.title) !== null && _e !== void 0 ? _e : "Forwarded message:")
                .setDescription(message.content);
            ((_f = options.embed) === null || _f === void 0 ? void 0 : _f.timestamp) && embed.setTimestamp(message.createdAt);
            ((_g = options.embed) === null || _g === void 0 ? void 0 : _g.author) && embed.setAuthor(username + "#" + author.discriminator, avatarURL, message.url);
            ((_j = (_h = options.embed) === null || _h === void 0 ? void 0 : _h.fields) === null || _j === void 0 ? void 0 : _j.author) && embed.addField('Author', "<@" + author.id + ">", true);
            ((_l = (_k = options.embed) === null || _k === void 0 ? void 0 : _k.fields) === null || _l === void 0 ? void 0 : _l.server) && embed.addField('Server', message.guild.name, true);
            ((_o = (_m = options.embed) === null || _m === void 0 ? void 0 : _m.fields) === null || _o === void 0 ? void 0 : _o.channel) && embed.addField('Channel', "#" + message.channel.name, true);
            embeds.push(embed);
        }
        else {
        ...
        if (hook) {
            let sendHook = () => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!hook)
                    throw "Not hook";
                let usernameDisplay = ((_p = options.webhookUsername) !== null && _p !== void 0 ? _p : username) + (options.webhookUsernameChannel ? " - #" + message.channel.name : "");
                if (!edit) {
                    return {
